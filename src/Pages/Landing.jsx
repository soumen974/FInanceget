    ...
    <>
      ...
      <div className="min-h-screen bg-white dark:bg-[#0a0a0a] text-gray-900 dark:text-white transition-colors duration-300">
        ...
        <footer className="dark:bg-[#1414145e] bg-[#0a0a0a] py-12 px-4 text-gray-400">
          ...
          <div className="mt-8 text-center text-xs border-t border-[#222222a0] pt-4">© {new Date().getFullYear()} FinanceGet , Made By<a href="https://soumenbhunia.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-indigo-400 hover:text-indigo-300"> Soumen Bhunia </a></div>
        </footer>
      </div>
    </>
  );
